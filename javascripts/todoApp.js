...
(function(){
  var ref$, dropWhile, filter, map, takeWhile, zip, TodoItem, TodoList, TodoApp;
  ref$ = require("prelude-ls"), dropWhile = ref$.dropWhile, filter = ref$.filter, map = ref$.map, takeWhile = ref$.takeWhile, zip = ref$.zip;
